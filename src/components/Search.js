    ...
    return (
      <div>
        <div style={{ position: 'fixed', width: '100%', backgroundColor: 'black' }}>
          <div style={{ height: 76, backgroundColor: 'gold' }}>
          ...
          <div className="clearfix" style={{ margin: 16 }}>
            <form onSubmit={this.onSubmit}>
              <input style={{ float: 'left', width: 330, height: 36, fontSize: 16, outlineColor: 'gold', paddingLeft: 5 }} ref="search-phrase" type="text" placeholder="Search" />
              <button style={{ float: 'left', cursor: 'pointer', backgroundColor: 'gold', border: 'none', padding: 2, outline: 'none', marginLeft: 4, width: 44 }}>
